...
Aggiornare il contenuto di "example_data_fqdn.json" con i dati che si desidera condividere:
...
```
IOC": 	{
	"domain.ltd":["5f0ffd98d4a68953caefbb55c5f2f250"],
	"anotherDomain.ltd":[]
	}
```
Nel primo caso il FQDN "domain.ltd avrà in IoC related con MD5 "5f0ffd98d4a68953caefbb55c5f2f250".

Nel secondo caso, verrà indicato come malevolo solo il FQDN "anotherDomain.ltd" senza hash relazionati.

## Dopo eseguire il seguente comando:

`python Report_FQDN_Producer.py example_data_ip.json`
